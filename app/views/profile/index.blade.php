        ...
        <div class="container">
            <div class="row">
                <figure class="col-md-3">
                    {{ HTML::image(Auth::user()->picture, $user->name, ['class' => 'img-responsive']) }}
                    <div class="settings champ-box">
                        ...
                        <section>
                            <ul class="settings-list">
                                <li><a href="#"><i class="icon icon-user"></i> Editar Perfil</a></li>
                                <li><a href="#"><i class="icon icon-key"></i> Alterar Senha</a></li>
                                <li><a href="#"><i class="icon icon-sign-out"></i> Sair</a></li>
                            </ul>
                        </section>
                    </div>
                </figure>
