    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <p>O ponto principal pela escolha do BCash é que podemos repassar o dinheiro para um conta bcash sua, sem que precisassemos fazer isso manualmente. Dessa forma, você saberá que assim que recebermos o dinheiro, a sua parte também será recebida, vamos cuidar também da parte de cancelamento, estorno e reclamações, tudo para que você não tenha essa dor de cabeça. Obviamente isso tem um custo, que a Battleroad já conta em suataxa.</p>
                <h3>Mas quanto é essa taxa da Battleroad?</h3>
                <p>A Battleroad cobra 10% sobre as transações, porém chamamos essa taxa de "Taxa Transparente". Por que?Porque essa taxa é transparente tanto para o organizador quanto para o jogador. Funciona assim: </p>
                <p>Vamos supor que para seu campeonato, você deseja receber R$20 de seus jogadores. Na hora de divulgarmos o seu campeonato, vamos mostrar o preço de R$22,22 para o pagamento. Se retirarmos 10% ou R$2,22 de umainscrição, você irá receber exatamente os R$20,00.</p>
