    ...
    <div class="container how-it-works" id="how-player">
        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <p>Você também precisa definir a data do campeonato. Essa data é muito importante, porque será baseada nela que definiremos a data de finalização dos pagamentos, por exemplo, se você disser que o campeonato começa no dia 10/01/2015, no dia 07/08/2015 enviaremos e-mails aos jogadores que se inscreveram mas ainda não pagaram o campeonato lembrando sobre o pagamento. Isso porque alguns tipos de pagamento necessitam de 2 dias para confirmação, como boleto e depósito.</p>
            </div>
            <div class="col-md-7">
        ...
        Vamos supor que para seu campeonato, você deseja receber R$20 de seus jogadores. Na hora de divulgarmos o seu campeonato, vamos mostrar o preço de R$22,22 para o pagamento. Se retirarmos 10% ou R$2,22 de uma inscrição, você irá receber exatamente os R$20,00.</p>

        <h3>Mas por que 10%?</h3>
        <p>Além de cobrirmos a taxa do sistema de pagamento, temos os custos do servidor e implementação de novas funcionalidades. Mais pra frente pretendemos diminuir essa taxa e monetizar a Battleroad de alguma forma. Queremos que a comunidade de E-Sports cresça no Brasil, e a única forma de fazermos isso é tornando acessível a todos, seja desenvolvedor ou organizador.</p>
